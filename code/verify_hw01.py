...
def main() -> None:
    ...
    def verify_required_files() -> dict[str, Any]:
        required = [
            ...
            "reports/hw01/PART4_RUN_LOG.txt",
        ]
    ...
    def verify_html() -> dict[str, Any]:
        html_path = ROOT / "HW1-{Eric Zhao}.html"
    ...
    def verify_model_adapter() -> dict[str, Any]:
        ...
        agents_source = (ROOT / "agents_demo.py").read_text(encoding="utf-8")
        client_source = (ROOT / "hw1_client.py").read_text(encoding="utf-8")
        compile(adapter_source, "src/model_client.py", "exec")
        compile(agents_source, "agents_demo.py", "exec")
        compile(client_source, "hw1_client.py", "exec")
        ...
        return {
            ...
            "consumers": ["agents_demo.py", "hw1_client.py"],
        }
